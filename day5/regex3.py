# -*- coding: utf-8 -*-
"""
Created on Sat May 11 11:20:23 2019
...
reg=r'^[456][0-9]{3}-?[0-9]{4}-?[0-9]{4}-?[0-9]{4}'
while True:
    credit=input("enter credit ").strip()
    cond1=re.match(reg,credit)
    cond2=re.search(r'(\d)\1{3,}',credit.replace('-',''))
