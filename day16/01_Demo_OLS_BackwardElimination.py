...
#kk->>import statsmodels.formula.api as sm
#kk-->features_obj = np.append(np.ones((214,1)), features1, axis=1)
...
#kk-->the value which has more p value that is less important so remove it
#kk-->do it till the value is more than 5%
