...
data = {"name":"pareerk","college":"GIT","branch":"cs","phone":834330382}
...
def get_method():
    response = requests.get("http://13.127.155.43/api_v0.1/receiving/get?name=pareerk,college=GIT,branch=cs,phone=834330382")
    return response
